...
class BNInception(nn.Module):
    ...
    def features(self, x):
        ...
        # stage3
        inception_3a_output_out = self._block_3a(pool2_3x3_s2_out)
        inception_3b_output_out = self._block_3b(inception_3a_output_out)
        inception_3c_output_out = self._block_3c(inception_3b_output_out)

        inception_4a_output_out = self._block_4a(inception_3c_output_out)
        inception_4b_output_out = self._block_4b(inception_4a_output_out)
        inception_4c_output_out = self._block_4c(inception_4b_output_out)
        inception_4d_output_out = self._block_4d(inception_4c_output_out)
        inception_4e_output_out = self._block_4e(inception_4d_output_out)

        inception_5a_output_out = self._block_5a(inception_4e_output_out)
        inception_5b_output_out = self._block_5b(inception_5a_output_out)
